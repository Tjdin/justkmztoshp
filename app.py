...
# Custom Holographic Globe & GA Hologram Styling
st.markdown(
    """
    <style>
    .holo-container {
    ...
    .globe-sphere {
        ...
        height: 100px;
        border-radius: 50%;
        background: radial-gradient(circle at 30% 30%, #00ffcc 0%, #0055ff 60%, #000814 100%);
        box-shadow: 0 0 25px rgba(0, 255, 204, 0.5), inset 0 0 15px rgba(255, 255, 255, 0.4);
        position: relative;
    ...
    /* Flickering Holographic GA Text/Icon Emanating Above */
    .ga-hologram {
        position: absolute;
        top: -35px;
        ...
        font-size: 24px;
        color: #00ffcc;
        text-shadow: 0 0 8px #00ffcc, 0 0 20px #0055ff, 0 0 30px #00ffcc;
        animation: flickerHolo 2.5s infinite;
        letter-spacing: 2px;
        z-index: 10;
    }
    ...
    @keyframes flickerHolo {
        0%, 19%, 21%, 23%, 25%, 54%, 56%, 100% {
            opacity: 0.95;
            text-shadow: 0 0 8px #00ffcc, 0 0 20px #0055ff;
    ...
    @keyframes pulseGlobe {
        0% { transform: scale(0.95); box-shadow: 0 0 15px rgba(0, 255, 204, 0.4); }
        100% { transform: scale(1.05); box-shadow: 0 0 30px rgba(0, 255, 204, 0.8); }
    }
    ...
    <div class="holo-container">
        <div class="ga-hologram">⚡ GA-HOLO ⚡</div>
